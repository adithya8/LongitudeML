...
def read_dlatk_data():
    base_dict = dict(db="ptsd_stop", msg_table="whisper_transcripts_v3", feature_tables=["feat$roberta_ba_meL11con$whisper_transcripts_v3$user_day_id"],
                outcome_table="outcomes_v3_PCL_forecast", outcome_fields=["PCL_1_day_ahead", "PCL_3_days_ahead", "PCL_7_days_ahead"], timeid_field="day_id", 
...
if __name__ == '__main__':
    ...
    def stratify_sequences(batch):
        batch["folds"] = np.random.randint(0, num_folds, len(batch["seq_id"]))
        return batch
    ...
    merged_dataset.save_to_disk('/cronus_data/avirinchipur/ptsd_stop/forecasting/datasets/roberta_base_L11_PCL_1_3_7_days_ahead_v3_40combined_5fold')