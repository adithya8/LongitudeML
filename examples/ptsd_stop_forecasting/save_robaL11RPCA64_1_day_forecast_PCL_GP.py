...
def read_dlatk_data():
    base_dict = dict(db="ptsd_stop", msg_table="whisper_transcripts_v3", 
                ...
                outcome_table="outcomes_GPestimates_PCL_v3_forecast", outcome_fields=["PCL_GP_1_day_ahead"], timeid_field="day_id", 
...
if __name__ == '__main__':
    ...
    merged_dataset.save_to_disk('/cronus_data/avirinchipur/ptsd_stop/forecasting/datasets/roberta_base_L11_rpca64_PCL_GP_1_days_ahead_max90days_v3_40combined_5fold')